...
sys.stdout.write(f"tmp_var_deploy : {tmp_var_deploy}")
...
# récupération du nom du tempate extrav_vars
...
sys.stdout.write(f"final_var_deploy_dict : {final_var_deploy_dict}")
